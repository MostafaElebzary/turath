                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="single-item">
                                    <div class="single-item-image overlay-effect">
                                        <a href="{{url('program/'.$program->id)}}"><img src="{{$program->image}}" width="211px" height="300px" alt=""></a>
                                    </div>
                                    <div class="single-item-text">
                                        <h4><a href="{{url('program/'.$program->id)}}">{{$program->title}}</a></h4>
                                        <br>
                                        <p>                     {{\Illuminate\Support\Str::limit( $program->description  , 100, $end='...')}}
                                        </p>
                                    </div>
                                    <div class="button-bottom">
                                        <a href="{{url('program/'.$program->id)}}" class="button-default">المزيد<i class="fa fa-chevron-left"></i></a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
