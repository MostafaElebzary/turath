    ...
    <div class="app-content content container-fluid">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url()->previous() }}"> الموظفين
                    </a>
                </li>
            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input name="job" class="form-control" type="job" value="{{old('job')}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input name="mobile" class="form-control" type="number" value="{{old('mobile')}}"
